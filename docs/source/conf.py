...
# -*- coding: utf-8 -*-
#
# ipyturtle2 documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipyturtle2', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipyturtle2doc'
...
latex_documents = [
    (master_doc, 'ipyturtle2.tex', 'ipyturtle2 Documentation',
     'wangsijie', 'manual'),
]
